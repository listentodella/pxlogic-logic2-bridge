...
function defaultCaptureTelemetry() {
  return {
    status: 'idle',
    logicSampleRateHz: null,
    sampleRateHz: null,
    enabledChannels: [],
    channelSpan: null,
    pxlogicUsbSpeed: null,
    pxlogicLogicMode: null,
    pxlogicMode: null,
    pxlogicModePhysicalChannels: null,
    pxlogicModeMaxSampleRateHz: null,
    pxlogicEffectiveSampleRateHz: null,
    pxlogicSupported: null,
    pxlogicReason: null,
    pxlogicAvailableModes: [],
    thresholdVolts: null,
...
function applyCaptureRuntimeEvent(event) {
  if (event.type === 'capture-starting') {
    captureTelemetry = {
      ...
      status: 'starting',
      logicSampleRateHz: event.logicSampleRateHz ?? event.sampleRateHz ?? null,
      sampleRateHz: event.sampleRateHz ?? null,
      enabledChannels: event.enabledChannels || [],
      channelSpan: event.channelSpan ?? null,
      pxlogicUsbSpeed: event.pxlogicUsbSpeed ?? null,
      pxlogicLogicMode: event.pxlogicLogicMode ?? null,
      pxlogicMode: event.mode ?? null,
      pxlogicModePhysicalChannels: event.modePhysicalChannels ?? null,
      pxlogicModeMaxSampleRateHz: event.modeMaxSampleRateHz ?? null,
      pxlogicEffectiveSampleRateHz: event.effectiveSampleRateHz ?? event.sampleRateHz ?? null,
      pxlogicSupported: event.supported ?? null,
      pxlogicReason: event.reason ?? null,
      pxlogicAvailableModes: event.availableModes || [],
      thresholdVolts: event.thresholdVolts ?? null,
      triggerDescription: event.triggerDescription ?? null,
    };
  } else if (event.type === 'capture-plan') {
    Object.assign(captureTelemetry, {
      status: captureTelemetry.status === 'idle' ? 'configured' : captureTelemetry.status,
      logicSampleRateHz: event.logicSampleRateHz ?? captureTelemetry.logicSampleRateHz,
      sampleRateHz: event.effectiveSampleRateHz ?? captureTelemetry.sampleRateHz,
      ...
      pxlogicUsbSpeed: event.pxlogicUsbSpeed ?? captureTelemetry.pxlogicUsbSpeed,
      pxlogicLogicMode: event.pxlogicLogicMode ?? captureTelemetry.pxlogicLogicMode,
      pxlogicMode: event.mode ?? null,
      pxlogicModePhysicalChannels: event.modePhysicalChannels ?? null,
      pxlogicModeMaxSampleRateHz: event.modeMaxSampleRateHz ?? null,
      pxlogicEffectiveSampleRateHz: event.effectiveSampleRateHz ?? null,
      pxlogicSupported: event.supported ?? null,
      pxlogicReason: event.reason ?? null,
      pxlogicAvailableModes: event.availableModes || [],
    });
    ...
    Object.assign(captureTelemetry, {
      ...
      enabledChannels: event.enabledChannels || captureTelemetry.enabledChannels,
      channelSpan: event.channelSpan ?? captureTelemetry.channelSpan,
      pxlogicEffectiveSampleRateHz: event.effectiveSampleRateHz ?? captureTelemetry.pxlogicEffectiveSampleRateHz,
      pxlogicMode: event.mode ?? captureTelemetry.pxlogicMode,
      pxlogicModePhysicalChannels: event.modePhysicalChannels ?? captureTelemetry.pxlogicModePhysicalChannels,
      pxlogicModeMaxSampleRateHz: event.modeMaxSampleRateHz ?? captureTelemetry.pxlogicModeMaxSampleRateHz,
      pxlogicSupported: event.supported ?? captureTelemetry.pxlogicSupported,
      pxlogicReason: event.reason ?? captureTelemetry.pxlogicReason,
...
function startBridge(rawSettings) {
  ...
  const args = [
    ...
    ...(selectedDevice.serialNumber ? ['--pxlogic-serial', selectedDevice.serialNumber] : []),
    '--pxlogic-usb-speed', selectedDevice.usbSpeed || 'high',
    '--pxlogic-logic-mode', String(Number.isInteger(selectedDevice.logicMode) ? selectedDevice.logicMode : 0),
