...
const PXLOGIC_HINTS = {
  'enabled-channels': {
    title: '实际通道',
    body: '格子里填色的是本次采集实际启用的通道，描边的是未启用。选哪些通道由 Logic 2 决定，Bridge 只是把结果照实映射到 PXLogic 硬件并显示出来，所以这里不能点。颜色与 Logic 2 波形区里同一通道的颜色一致，方便对照。启用的通道越多、采样率越高，需要的 USB 带宽就越大。',
  },
  'threshold': {
    title: '电压判断阈值',
